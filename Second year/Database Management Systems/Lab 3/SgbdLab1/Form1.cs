...
namespace SgbdLab1
{
    ...
    {
        //pt modele
        private SqlConnection sqlConnection;//= new SqlConnection("Data Source=DESKTOP-I9RLVTA;Initial Catalog=LudwkDB;Integrated Security=True");
        ...
        //pt produse
        private SqlConnection sqlConnection2; //= new SqlConnection("Data Source=DESKTOP-I9RLVTA;Initial Catalog=LudwkDB;Integrated Security=True");
        ...
        //parametrii-liste
        private List<string> t2Columns;

        private List<string> tipuriDatet2Columns;
        private List<string> parametriiSql;
